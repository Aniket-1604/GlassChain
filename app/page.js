...
<h4 className="text-center text-black font-semibold text-xl">Click On The Entities To View Their AAS(Asset Administration Shell)</h4>
        <div className="flex justify-center items-center flex-wrap">
          {/* First Card */}
          <a href="https://industry-4o9k.onrender.com/suppliers" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/1.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
          ...
          {/* Second Card */}
          <a href="https://industry-4o9k.onrender.com/products" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/2.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
            <div style={{ flex: 2, padding: "16px" }}>
              <h2 className="font-bold text-black" style={{ marginBottom: "8px", fontSize: "1.5rem" }}>
                Product
          ...
          {/* Third Card */}
          <a href="https://industry-4o9k.onrender.com/oem_manufacturers" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/3.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
            <div style={{ flex: 2, padding: "16px" }}>
              <h2 className="font-bold text-black" style={{ marginBottom: "8px", fontSize: "1.5rem" }}>
                OEM Manufacturer
          ...
          {/* Fourth Card */}
          <a href="https://industry-4o9k.onrender.com/retailers" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/1.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
            <div style={{ flex: 2, padding: "16px" }}>
          ...
          {/* Fifth Card */}
          <a href="https://industry-4o9k.onrender.com/gorilla_glasses" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/4.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
            <div style={{ flex: 2, padding: "16px" }}>
              <h2 className="font-bold text-black" style={{ marginBottom: "8px", fontSize: "1.5rem" }}>
                Gorilla Glass
          ...
          {/* Sixth Card */}
          <a href="https://industry-4o9k.onrender.com/customers" className="card hover:scale-105 hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300 ease-in-out" style={{ display: "flex", border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", margin: "16px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", maxWidth: "800px", width: "100%", backgroundColor: "white" }}>
            <div style={{ flex: 1 }}>
              <img src="/5.png" alt="Card Image" style={{ width: 300, height: 250, objectFit: "cover" }} />
            </div>
            <div style={{ flex: 2, padding: "16px" }}>
              <h2 className="font-bold text-black" style={{ marginBottom: "8px", fontSize: "1.5rem" }}>
                Customer
